(window.webpackJsonp = window.webpackJsonp || []).push([
	[16], {
		...
		795: function(n, e, t) {
			"use strict";
			t.r(e), t.d(e, "schemaFilter", (function() {
				return o
			}));
			var i = t(0),
				r = t(695);
			...
			function o(n, e) {
				function t(t) {
					...
					if (o && a) {
						var u = o[a];
						if (!Object(r.a)(o, u)) return t.updateEvent("integrations", Object(i.a)(Object(i.a)({}, t.event.integrations), {
							All: !1,
							"Segment.io": !0
						})), t;
						var c = function(n, e) {
							...
							return (null !== (t = e.remotePlugins) && void 0 !== t ? t : []).forEach((function(n) {
								r.forEach((function(e) {
									(n.name.includes(e) || e.includes(n.name)) && o.push(n.name)
								}))
						...
						t.updateEvent("integrations", Object(i.a)(Object(i.a)(Object(i.a)({}, t.event.integrations), null == u ? void 0 : u.integrations), c))
					}
					return t
				}
				return {
